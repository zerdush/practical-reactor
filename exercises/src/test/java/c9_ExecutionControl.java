...
public class c9_ExecutionControl extends ExecutionControlBase {
    ...
    public void slow_down_there_buckaroo() {
        ...
        Flux<String> notifications = readNotifications().delayElements(Duration.ofSeconds(1))
    ...
    public void ready_set_go() {
        ...
        Flux<String> tasks =  semaphore().zipWith(tasks(), (signal, task) -> task)
                .flatMap(Function.identity());
//        semaphore().doOnNext((s) -> tasks.next());
